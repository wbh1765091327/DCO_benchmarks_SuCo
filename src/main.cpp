...
int main (int argc, char **argv)
{
    ...
    struct timeval start_preprocess, end_preprocess;
    gettimeofday(&start_preprocess, NULL);
    ...
    long int preprocess_time = (1000000 * (end_preprocess.tv_sec - start_preprocess.tv_sec) + end_preprocess.tv_usec - start_preprocess.tv_usec);
    cout << "The preprocess time is: " << preprocess_time / 1000.0 << "ms." << endl;
